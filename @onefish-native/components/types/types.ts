...
export type VariantType<Component extends keyof ITheme['components']> =
...
export type CustomComponentProps<T extends keyof ITheme['components']> =
  Partial<
    Exclude<
      {
    ...
    >
  >;
export type CustomPropsTemp<T extends keyof ITheme['components']> =
