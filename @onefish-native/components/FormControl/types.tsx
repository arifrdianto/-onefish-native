import { InterfaceBoxProps, IBoxProps } from '../Box';
import { IStackProps } from '../Stack';
import { ITextProps } from '../Text';
import { CustomProps } from '../types';

export interface InterfaceFormControlProps extends InterfaceBoxProps {
  /**
...
export interface IFormControlLabelProps extends IFormControlProps {
   ...
   */
  _disabled?: Partial<IBoxProps>;
  // _focus?: any;
  /**
   * Passed props will be applied on invalid state.
   */
  _invalid?: Partial<IBoxProps>;
  /**
